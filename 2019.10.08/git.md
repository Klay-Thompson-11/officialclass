...
SVN：集中式
    弊端:版本控制必须需要网络支持，一般SVN都是局域网，只能是公司内部人员使用，外界的人想参与开发是比较麻烦的，中央服务器不一定就稳定，一旦出事中央服务器所有资源都GG。
GIT：分布式
...
- 把本地git的版本上传到github上管理
    ...
    - 设置秘钥:
        ssh-keygen -t rsa -C "2284413736@qq.com"
...
- 创建远程仓库
    ...
    ```
       比如: git remote add origin git@github.com:Klay-Thompson-11/2019-10-08.git
    ```
- 同步远程
